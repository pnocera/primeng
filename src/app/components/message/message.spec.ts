...
describe('UIMessage', () => {
    ...
    it('should change severity to success and text', () => {
        ...
        const iconEl = fixture.debugElement.query(By.css('.ng-message-icon'));
        const textEl = fixture.debugElement.query(By.css('.ng-message-text'));
        expect(messageEl.nativeElement).toBeTruthy();
        expect(messageEl.nativeElement.className).toContain("ng-message-success");
    ...
    it('should change severity to info', () => {
        ...
        const iconEl = fixture.debugElement.query(By.css('.ng-message-icon'));
        expect(messageEl.nativeElement).toBeTruthy();
        expect(messageEl.nativeElement.className).toContain("ng-message-info");
    ...
    it('should change severity to error', () => {
        ...
        const iconEl = fixture.debugElement.query(By.css('.ng-message-icon'));
        expect(messageEl.nativeElement).toBeTruthy();
        expect(messageEl.nativeElement.className).toContain("ng-message-error");
    ...
    it('should change severity to warning', () => {
        ...
        const iconEl = fixture.debugElement.query(By.css('.ng-message-icon'));
        expect(messageEl.nativeElement).toBeTruthy();
        expect(messageEl.nativeElement.className).toContain("ng-message-warn");
