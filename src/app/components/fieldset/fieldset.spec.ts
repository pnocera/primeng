...
describe('Fieldset', () => {
    ...
    it('should display the legend', () => {
        ...
        const headerEl = fixture.debugElement.query(By.css('.ng-fieldset-legend-text'));
    ...
    it('should not render toggle icon when not toggleable', () => {
        fixture.detectChanges();
        const toggleIcon = fixture.debugElement.query(By.css('.ng-fieldset-toggler'));
    ...
    it('should toggle the fieldset when toggler is clicked', fakeAsync(() => {
        fieldset.toggleable = true;
        fixture.detectChanges();
        const togglerEl = fixture.nativeElement.querySelector('.ng-fieldset-legend').children[0];
